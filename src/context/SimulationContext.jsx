...
// INTEGRATION LAYER — bridges all modules
// Simulation imports
import { WaterFlowEngine }                                   from '@sim/engine/WaterFlowEngine.js';
import { TimeController }                                    from '@sim/engine/TimeController.js';
import { updateNodeSensors, clearSensorHistory }             from '@sim/engine/SensorSimulator.js';
import { detectAnomalies, resetAlertCounter }                from '@sim/ai/AnomalyDetector.js';
import { detectBetweenNodeAnomalies }                       from '@sim/ai/BetweenNodeDetector.js';
import { generateRedistributionPlan, executePlan }           from '@sim/ai/DecisionEngine.js';
import { applyScenario }                                     from '@sim/scenarios/Scenarios.js';
import { issueRegistry, processIssues, resetIssueRegistry } from '@sim/engine/IssueManager.js';
import { generatePredictions, resetPredictions }            from '@sim/engine/PredictionEngine.js';
...
import { pipeAgingManager }                                 from '@sim/engine/PipeAgingManager.js';

// AI imports
import { autoFixEngine, runAutoFix, resetAutoFix }          from '@ai/engine/AutoFixEngine.js';

// Backend imports
import { supabase }                                         from '@backend/supabaseClient';

import cityNetwork from '@/data/cityNetwork.json';
